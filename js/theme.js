...
if ($('.owl-top-teacher').length) {
    $('.owl-top-teacher').owlCarousel({
        loop: true,
        margin: 30,
        nav: false,
        dots: true,
...
$(".filter-pro-box li a").on("click",function(){
...
if ($('.Famous-Musical-carousel').length) {
    $('.Famous-Musical-carousel').owlCarousel({
        loop: true,
        margin: 30,
        nav: false,
        dots: true,
...
$(".item-browse-box button").click(function(){
    var id = $(this).data("id");
     $(".audio-player[data-id='"+id+"']")[0].play(); 
})

$(".video-two__popup").click(function(){
    setTimeout(function(){
        $("#about-video")[0].play();
    }, 1000);
})
...
//     if (scrollt >= 400) {
//         $(".nav-right-ol").addClass("fix-nav-right");
//     } else {
//         $(".nav-right-ol").removeClass("fix-nav-right");
//     };

//     // var position = $(".nav-right-ol").position();
//     // console.log("left: " + position.left + ", top: " + position.top);

//     var position = $(".site-footer__upper").position();
//     console.log("left: " + position.left + ", top: " + position.top);
...
$(window).scroll(function () {
    ...
    var height = $(document).height() - 890;
    var x = $('.nav-right-ol').position();
    var widthIndex = $( document ).width();
    var heightM = $(document).height() - 1700;

 if(widthIndex >= 992){
    if($(window).scrollTop() + $(window).height() == $(document).height() || $(window).scrollTop() >= height )
    {
        $('.nav-right-ol').css('position', 'absolute');
        $('.nav-right-ol').css('bottom', '30px');
        $('.nav-right-ol').css('top', 'auto');

    }
    else if($(window).scrollTop() >= 350 ) {

        $('.nav-right-ol').css('position', 'fixed');
        $('.nav-right-ol').css('bottom', 'auto');
        $('.nav-right-ol').css('top', '55px');

    } else{

        $('.nav-right-ol').css('position', 'absolute');
        $('.nav-right-ol').css('bottom', 'auto');
        $('.nav-right-ol').css('top', '0%');

    }
 }else{

    if($(window).scrollTop() + $(window).height() == $(document).height() || $(window).scrollTop() >= heightM )
    {
        $('.nav-right-ol').css('position', 'absolute');
        $('.nav-right-ol').css('bottom', '30px');
        $('.nav-right-ol').css('top', 'auto');
